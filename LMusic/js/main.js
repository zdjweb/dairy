(() => {
    ...
    class LMusicAudio extends Audio {
        ...
        static play() {
            this.played = true;
            if (this.now) {
                this.now.play().catch(e => this.pause());
            }
    ...
    bindEvents(window, {
        ...
        DOMContentLoaded() {
            ...
            let LMusicState = window.parent.LMusicState;
            if (!LMusicState) {
                LMusicState = window.parent.LMusicState = new WeakMap;
            }
            if (!LMusicState[this]) {
                window.parent.postMessage({
                    type: 'init'
